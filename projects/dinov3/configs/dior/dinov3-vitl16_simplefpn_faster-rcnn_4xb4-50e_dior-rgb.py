...
dinov3_weights_path = (
    f"{dinov3_root}/DINOv3 ViT SAT-493M/"
    "dinov3_vitl16_pretrain_sat493m-eadcf0ff.pth"
)
work_dir = "./work_dirs/dinov3-vitl16_simplefpn_faster-rcnn_4xb4-50e_dior-rgb"
...
model = dict(
    ...
    neck=dict(
        type="SimpleFPN",
        backbone_channel=hidden_dim,
        in_channels=[hidden_dim // 4, hidden_dim // 2, hidden_dim, hidden_dim],
